...
(function dartProgram() {
  ...
  var A = {JS_CONST: function JS_CONST() {
    ...
    DriftRemoteException: function DriftRemoteException() {
    },
    ...
    initSqlJs() {
      ...
      if (t1 != null)
        return t1.future;
      completer = new A._AsyncCompleter(new A._Future($.Zone__current, type$._Future_SqlJsModule), type$._AsyncCompleter_SqlJsModule);
      ...
      if (!("initSqlJs" in t1._jsObject))
        ...
        type$.JsObject._as(t1.callMethod$1("initSqlJs")).callMethod$2("then", [A.allowInterop(A.sql_js___handleModuleResolved$closure(), type$.void_Function_dynamic)]);
    ...
    main() {
      ...
      t2 = type$.int;
      t2 = type$.nullable_void_Function_Event._as(new A.main_closure(new A.ServerImplementation(new A.DatabaseConnection(new A.WebDatabase(new A._WebDelegate(new A._IndexedDbStorage("useraccount_db.sqlite", false, true), null, null), false, true, new A.Lock(), new A.Lock())), false, A.LinkedHashMap_LinkedHashMap$_empty(t2, type$.QueryExecutor), A.LinkedHashMap_LinkedHashMap$_empty(t2, type$.CancellationToken_dynamic), A._setArrayType([], type$.JSArray_int), A.StreamController_StreamController$broadcast(true, type$.void), A.LinkedHashSet_LinkedHashSet$_empty(type$.DriftCommunication), new A._AsyncCompleter(new A._Future($.Zone__current, type$._Future_void), type$._AsyncCompleter_void))));
      type$.nullable_void_Function._as(null);
  ...
  A.DriftCommunication.prototype = {
    _handleMessage$1(msg) {
      ...
      if (msg instanceof A.SuccessResponse) {
        ...
        if (request != null)
          request.completer.completeError$2(new A.DriftRemoteException(), request.requestTrace);
  ...
  A.SqlJsDatabase.prototype = {
    ...
    runWithArgs$2(sql, args) {
      var t1 = this._obj;
      if (J.get$isEmpty$asx(args))
        t1.callMethod$2("run", [sql]);
      else
        t1.callMethod$2("run", [sql, A.JsArray_JsArray$from(args, type$.dynamic)]);
    },
  ...
  (function inheritance() {
    ...
    _inheritMany(J.JavaScriptObject, [J.LegacyJavaScriptObject, A.EventTarget, A.Blob, A.DomException, A.Event, A.ImageData, A._Storage_JavaScriptObject_MapMixin, A.IdbFactory, A.KeyRange, A.ObjectStore]);
